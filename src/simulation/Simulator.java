...
public class Simulator implements WorldListener {
	...
	private void loadDisasters(String path) throws Exception {
		...
		while (line != null) {
			...
			int startCycle =(int) Integer.parseInt(info[0]);
	...
	public void nextCycle() throws BuildingAlreadyCollapsedException, CannotTreatException, CitizenAlreadyDeadException {
